  ...
  extends Controller
{
    ...
    if ($request->isPost()) {
      ...
      try {
        ...
        if ($this->authorization->authenticate($credentials, $remember,
          ...
          return $this->redirect($response, 'ERP\Home');
        } else {
    ...
    array $args)
  {
    ...
    $this->breadcrumb->push("Confirmação da solicitação de redefinição "
      . "de senha",
      $this->path('ERP\SentInstructions', [
        'UUID' => $contractorUUID, 'Email' => $email
      ])
    );
    ...
    // Renderiza a página
    return $this->render($request, $response,
      'erp/auth/sentinstructions.twig',
      [ 'uuid' => $contractorUUID,
        'email' => $email ])
    ;
  }
    ...
    array $args)
  {
    ...
    if ( array_key_exists('Token', $args) ) {
      ...
      return $this->redirect($response, 'ERP\Login',
        [ 'UUID' => $contractorUUID ])
      ;
    }
  ...
  public function register(Request $request, Response $response)
  {
    ...
    return $this->render($request, $response, 'erp/auth/register.twig');
  }
