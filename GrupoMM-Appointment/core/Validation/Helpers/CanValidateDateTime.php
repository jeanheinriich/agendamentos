...
trait CanValidateDateTime
{
   ...
   */
  protected function isDateTime(string $format, string $value): bool
  {
    $exceptionalFormats = [
      'c' => 'Y-m-d\TH:i:sP',
      'r' => 'D, d M Y H:i:s O',
   ...
   * @param int[] $info
   */
  protected function isDateTimeParsable(array $info): bool
  {
   ...
   * @param mixed[] $info
   */
  protected function isDateInformation(array $info): bool
  {
    if ($info['day']) {
